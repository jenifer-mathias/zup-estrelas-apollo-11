...
public class Forca {                               // final pq a variável não pode assumir outro valor
	...
	public String sortearPalavra() throws IOException {                       // p tratar exceção/ erro de input output (IOException)
		...
		FileReader fileReader = new FileReader("C:\\Users\\jenif\\OneDrive\\Documentos\\palavras.txt");
	...
	public Forca() throws IOException {                                       // método que nele consta o jogo em si (usando já o tratamento de exceções
